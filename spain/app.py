"""
BW ESS — Spanish Power Market Dashboard
Live Spanish electricity market data for trading and dispatch decisions.
...
app = dash.Dash(
    __name__,
    title="BW ESS \u2014 Spanish Power Market",
