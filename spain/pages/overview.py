"""Tab 1: Market Overview — current snapshot of the Spanish power market."""
...
def register_callbacks(app):
    @app.callback(
        [
            ...
            Output(
                "es-overview-price-chart", "figure"
            ),
            Output(
                "es-overview-gen-chart", "figure"
            ),
            Output(
                "es-overview-residual-chart", "figure"
            ),
            Output(
                "es-overview-trend-chart", "figure"
            ),
        ],
        [
