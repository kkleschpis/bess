"""Tab 2: Price Analysis — DA prices, heatmaps, spreads for Spain."""
...
def register_callbacks(app):
    @app.callback(
        [
            ...
            Output(
                "es-prices-timeseries", "figure"
            ),
            Output("es-prices-heatmap", "figure"),
            Output("es-prices-duration", "figure"),
            Output("es-prices-spread", "figure"),
            Output("es-prices-negative", "figure"),
        ],
        [
